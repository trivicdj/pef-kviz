...
class Play extends Component {
    ...
    handleQuitButtonClick = () => {
        this.playButtonSound();
        if (window.confirm("Da li si siguran da želiš da napustiš kviz?")) {
    ...
    handleHints = () => {
        if (this.state.hints > 0) {
            ...
            options.forEach((option, index) => {
                if (
                    option.innerHTML.trim().toLowerCase() ===
                    this.state.answer.toLowerCase()
                ) {
                    indexOfAnswer = index;
                }
    ...
    render() {
        ...
        return ( <
            ...
            Fragment >
            <
            audio ref = { this.correctSound }
            src = { correctNotification } > { " " } <
            /audio>{" "} <
            audio ref = { this.wrongSound }
            src = { wrongNotification } > { " " } <
            /audio>{" "} <
            audio ref = { this.buttonSound }
            src = { buttonSound } > { " " } <
            /audio>{" "} <
            /Fragment>{" "} <
            ...
            span className = "left"
            style = {
                { float: "left" } } > { " " } { currentQuestionIndex + 1 }
            of { numberOfQuestions } { " " } <
            /span>{" "} <
            span className = {
                classnames("right valid", {
            ...
            className = "option" > { " " } { currentQuestion.optionA } { " " } <
            /p>{" "} <
            p onClick = { this.handleOptionClick }
            className = "option" > { " " } { currentQuestion.optionB } { " " } <
            /p>{" "} <
            /div>{" "} <
            div className = "options-container" >
            <
            p onClick = { this.handleOptionClick }
            className = "option" > { " " } { currentQuestion.optionC } { " " } <
            /p>{" "} <
            p onClick = { this.handleOptionClick }
            className = "option" > { " " } { currentQuestion.optionD } { " " } <
            /p>{" "} <
            /div>{" "} <
            /div>{" "} <
